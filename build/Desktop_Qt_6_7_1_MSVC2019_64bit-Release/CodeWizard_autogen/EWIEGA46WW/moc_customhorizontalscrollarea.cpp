...
struct qt_meta_stringdata_CLASScustomHorizontalScrollAreaENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASScustomHorizontalScrollAreaENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASScustomHorizontalScrollAreaENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject customHorizontalScrollArea::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASScustomHorizontalScrollAreaENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASScustomHorizontalScrollAreaENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASScustomHorizontalScrollAreaENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *customHorizontalScrollArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASScustomHorizontalScrollAreaENDCLASS.stringdata0))
