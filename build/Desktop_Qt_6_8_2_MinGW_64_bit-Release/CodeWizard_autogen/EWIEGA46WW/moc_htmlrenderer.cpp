...
namespace {
struct qt_meta_tag_ZN12HtmlRendererE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12HtmlRendererE = QtMocHelpers::stringData(
    "HtmlRenderer"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12HtmlRendererE[] = {
...
Q_CONSTINIT const QMetaObject HtmlRenderer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12HtmlRendererE.offsetsAndSizes,
    qt_meta_data_ZN12HtmlRendererE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12HtmlRendererE_t,
        // Q_OBJECT / Q_GADGET
...
void *HtmlRenderer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12HtmlRendererE.stringdata0))
