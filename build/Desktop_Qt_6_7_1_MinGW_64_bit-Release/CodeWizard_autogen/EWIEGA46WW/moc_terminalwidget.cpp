...
struct qt_meta_stringdata_CLASSTerminalWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTerminalWidgetENDCLASS = QtMocHelpers::stringData(
    "TerminalWidget",
    "readOutput",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTerminalWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TerminalWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTerminalWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTerminalWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTerminalWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TerminalWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTerminalWidgetENDCLASS.stringdata0))
