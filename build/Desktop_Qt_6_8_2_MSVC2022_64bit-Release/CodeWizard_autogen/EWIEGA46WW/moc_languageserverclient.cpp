...
namespace {
struct qt_meta_tag_ZN20LanguageServerClientE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN20LanguageServerClientE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20LanguageServerClientE[] = {
...
Q_CONSTINIT const QMetaObject LanguageServerClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20LanguageServerClientE.offsetsAndSizes,
    qt_meta_data_ZN20LanguageServerClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20LanguageServerClientE_t,
        // Q_OBJECT / Q_GADGET
...
void LanguageServerClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (LanguageServerClient::*)(const QStringList & , int );
            if (_q_method_type _q_method = &LanguageServerClient::completionReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _q_method_type = void (LanguageServerClient::*)(const QStringList & , const QList<int> & , const QList<int> & , const QList<int> & , const QList<int> & , const QList<int> & );
            if (_q_method_type _q_method = &LanguageServerClient::receivedDiagnostics; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (LanguageServerClient::*)(const QString & );
            if (_q_method_type _q_method = &LanguageServerClient::serverErrorOccurred; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (LanguageServerClient::*)(int , QProcess::ExitStatus );
            if (_q_method_type _q_method = &LanguageServerClient::serverFinished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (LanguageServerClient::*)();
            if (_q_method_type _q_method = &LanguageServerClient::initializeResponseReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (LanguageServerClient::*)(QString , QString , int );
            if (_q_method_type _q_method = &LanguageServerClient::hoverInformationReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _q_method_type = void (LanguageServerClient::*)(const QJsonArray & );
            if (_q_method_type _q_method = &LanguageServerClient::codeActionsReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
...
void *LanguageServerClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20LanguageServerClientE.stringdata0))
